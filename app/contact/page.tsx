    ...
    <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-6">
      <div className="rounded-2xl border border-slate-700/80 bg-slate-950/70 p-4 sm:p-5 mb-8 flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-800 text-primary shrink-0">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-500 px-4 py-3 text-sm font-semibold text-slate-950 shadow-[0_18px_40px_-20px_rgba(37,211,102,0.8)] transition hover:bg-emerald-400 w-full sm:w-auto"
        >
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-slate-950 text-white shrink-0">
